...
class TypeTree(models.Model):
	...
	root = models.ForeignKey(Root, on_delete=models.CASCADE, verbose_name='Raiz')
	trunk = models.ForeignKey(Trunk, on_delete=models.CASCADE, verbose_name='Tronco')
	branch = models.ForeignKey(Branch, on_delete=models.CASCADE, verbose_name='Rama')
	leaf = models.ForeignKey(Leaf, on_delete=models.CASCADE, verbose_name='Hoja')
...
class Tree(models.Model):
	...
	circumference = models.PositiveIntegerField(default=1, verbose_name='Circunferencia en centimetros')
